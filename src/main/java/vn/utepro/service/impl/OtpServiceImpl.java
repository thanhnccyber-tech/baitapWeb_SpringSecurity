...
import vn.utepro.entity.OtpToken;
import vn.utepro.repository.OtpTokenRepository;
...
public class OtpServiceImpl implements OtpService {
    ...
    public OtpServiceImpl(OtpTokenRepository repository,
    ...
    public void sendRegisterOtp(String email) {
        send(email, "REGISTER", "UTEShop - Xác nhận đăng ký tài khoản");
    }

    @Override
    @Transactional
    public void sendResetPasswordOtp(String email) {
        send(email, "RESET_PASSWORD", "UTEShop - OTP đặt lại mật khẩu");
    }
